...
const styles = StyleSheet.create({
  ...
  dayText: { ...typography.caption, fontSize: 12, color: colors.inkMuted, fontVariant: ['tabular-nums'] }, completedDay: { backgroundColor: colors.white, borderColor: colors.white }, selectedCompleted: { borderColor: colors.borderStrong, borderWidth: 2 }, completedText: { color: colors.onPrimary, fontWeight: '700' },
  ...
  legend: { flexDirection: 'row', justifyContent: 'center', gap: 18, paddingTop: 12, paddingBottom: 18 }, legendItem: { flexDirection: 'row', alignItems: 'center', gap: 6 }, legendMark: { height: 10, width: 10, borderRadius: 3, backgroundColor: colors.white }, legendToday: { height: 10, width: 10, borderRadius: 3, borderWidth: 1, borderColor: colors.inkMuted },
