...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 20, paddingVertical: 12, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border },
  ...
  feed: { padding: 20, gap: 14, paddingBottom: 32, width: '100%', maxWidth: 680, alignSelf: 'center' },
  intro: { gap: 6, paddingTop: 0, paddingBottom: 2 },
  ...
  feedTitle: { ...typography.hero, fontSize: 26, lineHeight: 32, color: colors.ink },
