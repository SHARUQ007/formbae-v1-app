...
const styles = StyleSheet.create({
  card: { backgroundColor: colors.panel, borderRadius: 20, borderWidth: 1, borderColor: colors.border, overflow: 'hidden' },
  compact: { flexDirection: 'row', alignItems: 'center', padding: 12, gap: 12, borderRadius: 16 },
  cover: { width: '100%', aspectRatio: 1.85, backgroundColor: colors.panelRaised },
  thumbnail: { width: 76, height: 80, borderRadius: 10, flexShrink: 0 },
  copy: { padding: 18, gap: 12 },
  ...
  footer: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'space-between', gap: 12, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: colors.border, paddingTop: 12, marginTop: 2 },
  published: { gap: 2 },
  ...
  readArrow: { width: 30, height: 30, borderRadius: 15, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.panelRaised, alignItems: 'center', justifyContent: 'center' },
